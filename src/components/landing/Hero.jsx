...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-blue-100 via-purple-100 to-pink-100 pt-0">
      ...
      <div className="relative max-w-7xl mx-auto px-4 md:px-6 py-4 md:py-6 w-full">
        <motion.div
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            {/* Right side - Hero Image + Download Button */}
            <motion.div
              initial={{ opacity: 0, x: 30 }}
              animate={{ opacity: 1, x: 0 }}
            ...
            >
              <div className="w-full rounded-3xl shadow-2xl overflow-hidden transition-all duration-500 hover:shadow-[0_0_40px_rgba(255,215,0,0.6),0_0_60px_rgba(255,182,193,0.4),0_0_80px_rgba(135,206,250,0.3)] mb-6">
                <motion.img
              ...
              >
                <Button
                  size="lg"
                  className="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white px-6 md:px-10 py-6 md:py-7 text-base md:text-xl lg:text-2xl rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-300 transform hover:scale-105 font-bold w-full"
